...
int criarObjeto(int cdobj,char texto[MAXLEN_label],float largura,float altura, float x, float y, int customalign);
...
int main(){
    ...
    criarObjeto(btnjogar," Play",190, 60, 0, 0,CENTER);
    criarObjeto(btnOpcoes," Options",190, 60, 0, 60,CENTER);
    criarObjeto(btnCreditos," Credits",190, 60, 0, 120,CENTER);
    criarObjeto(personagem,"Kaidwal",50,50,100,100,0);
    criarObjeto(mesa,"",50,50,200,100,0);
    criarObjeto(frontup,"",SCREEN_H,0,0,0,0);
    criarObjeto(frontright,"",0,SCREEN_V,SCREEN_H,0,0);
    criarObjeto(frontdown,"",SCREEN_H,0,0,SCREEN_V,0);
    criarObjeto(frontleft,"",0,SCREEN_V,0,0,0);
    //fundo branco
    limparTela();
    //carregar imagens
